...
class VacationController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = getColumnsIndex(new VacationType(), array("*"), array("com_code" => $com_code), "id", "ASC")->get();
        if (!empty($data)) {
    ...
    public function store(VacationRequest $request)
    {
        try {
            $com_code = auth()->user()->com_code;
            $CheckExsists = get_Columns_where_row(new VacationType(), array("id"), array("com_code" => $com_code, 'name' => $request->name));
