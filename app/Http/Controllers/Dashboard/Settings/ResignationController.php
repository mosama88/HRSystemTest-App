...
class ResignationController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = getColumnsIndex(new Resignation(), array("*"), array("com_code" => $com_code), "id", "DESC")->get();
        if (!empty($data)) {
    ...
    public function store(ResignationRequest $request)
    {
        try {
            $com_code = auth()->user()->com_code;
            $CheckExsists = get_Columns_where_row(new Resignation(), array("id"), array("com_code" => $com_code, 'name' => $request->name));
    ...
    public function edit($id)
    {
        try {
            $com_code = auth()->user()->com_code;
            $data = get_Columns_where_row(new Resignation(), array("*"), array("com_code" => $com_code, "id" => $id));
            if (empty($data)) {
