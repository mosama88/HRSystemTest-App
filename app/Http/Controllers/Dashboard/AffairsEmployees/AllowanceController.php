...
class AllowanceController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = getColumnsIndex(new Allowance(), array("*"), array("com_code" => $com_code), 'id', 'DESC')->get();
  ...
  if (!empty($data)) {
    ...
    public function store(AllowanceRequest $request)
    {
        try {
            ...
            $com_code = auth()->user()->com_code;
            $CheckExsists = get_Columns_where_row(new Allowance(), array("id"), array("com_code" => $com_code, 'name' => $request->name));
    ...
    public function edit($id)
    {
        ...
        $com_code = auth()->user()->com_code;
        $data = get_Columns_where_row(new Allowance(), array("*"), array("com_code" => $com_code, 'id' => $id));
        if (empty($data)) {
    ...
    public function destroy($id)
    {
        try {
            ...
            $counterUsed = get_count_where(new EmployeeFixedAllowance(), array("com_code" => $com_code, "allowance_id" => $id));
