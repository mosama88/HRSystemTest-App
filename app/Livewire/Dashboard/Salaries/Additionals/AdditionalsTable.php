...
namespace App\Livewire\Dashboard\Salaries\Additionals;
...
class AdditionalsTable extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('dashboard.salaries.additionals.additionals-table', compact('data'));
    }
}
