...
namespace App\Livewire\Dashboard\Salaries\MainSalaryEmployees;
...
class MainSalaryEmployeesTable extends Component
{
    ...
    public function render()
    {
        ...
        return view('dashboard.salaries.mainSalaryEmployees.main-salary-employees-table',compact('data'));
    }
}
