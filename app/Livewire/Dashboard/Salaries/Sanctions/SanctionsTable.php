...
namespace App\Livewire\Dashboard\Salaries\Sanctions;
...
class SanctionsTable extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('dashboard.salaries.sanctions.sanctions-table', compact('data'));
    }
}
