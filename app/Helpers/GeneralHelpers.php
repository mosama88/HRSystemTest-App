...
function getColumnsIndex($model, $Columns_name = [], $where = [], $order_by = 'id', $order_type = 'DESC')
{
...
function insert($model = null, $arrayToInsert = [], $returnData = false)
{
    ...
    if ($returnData == true) {
        $data = get_Columns_where_row($model, ['*'], $arrayToInsert);
...
function get_Columns_where_row($model = null, $columns_names = [], $where = [])
{
...
function get_count_where($model = null, $where = [])
{
