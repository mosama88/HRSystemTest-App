...
@section('title', 'قائمة جهاز البصمه')
@section('css')
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">بيانات بصمات الموظفين بالشهور الماليه </h4><span
                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">
                            جدول بصمات الموظفين بالشهور الماليه
                        </h4>
                                    ...
                                    <tbody>
                                        @foreach ($data as $info)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($info->is_open != 0)
                                                        <a href="{{ route('dashboard.attendanceDepartures.show', $info->id) }}"
