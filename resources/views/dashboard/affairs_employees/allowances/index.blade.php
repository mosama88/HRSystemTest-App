...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">نوع البدلات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    جدول
                    نوع البدلات</span>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <div class="mb-3 mb-xl-0">
                <div class="btn-group dropdown">
                    ...
                    @include('dashboard.affairs_employees.allowances.create')
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">جدول نوع البدلات</h4>
                            ...
                            <table class="table text-md-nowrap" id="example2">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="wd-15p border-bottom-0"> نوع البدلات</th>
                                ...
                                <tbody>
                                    ...
                                    @endif
                                    @include('dashboard.affairs_employees.allowances.edit')
                                    </tr>
                                    @include('dashboard.affairs_employees.allowances.delete')
                        @endforeach
                        </tbody>
                        </table>
                    @else
