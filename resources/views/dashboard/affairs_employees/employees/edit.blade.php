...
@section('title', 'تعديل بيانات موظف جديد')
@section('css')
    <!---Internal  Prism css-->
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h5 class="content-title mb-0 my-auto">تعديل بيانات الموظف </h5><span
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('dashboard.employees.update', $data['id']) }}" method="POST"
                        ...
                        <div class="main-content-label mg-b-5">
                            بيانات <span class="text-danger">{{ $data['name'] }}</span>
                            كود الموظف <span class="text-danger">( {{ $data['employee_code'] }} )</span>
                        </div>
                        <p class="mg-b-20"></p>
                        <div class="text-wrap">
                            <div class="example">
                                <div class="panel panel-primary tabs-style-2">
                                        ...
                                        <div class="tab-content">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input autofocus type="text" name="fp_code" id="fp_code"
                                                                ...
                                                                class="form-control"
                                                                value="{{ old('fp_code', $data['fp_code']) }}">
                                                            @error('fp_code')
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="gender" id="gender" class="form-control">
                                                                ...
                                                                <option @if (old('gender', $data['gender']) == 'Male') selected @endif
                                                                    value="Male">ذكر</option>
                                                                <option @if (old('gender', $data['gender']) == 'Female') selected @endif
                                                            ...
                                                            <select name="qualification_id" id="qualification_id"
                                                                ...
                                                                @if (@isset($other['qualifications']) && !@empty($other['qualifications']))
                                                                    @foreach ($other['qualifications'] as $info)
                                                                        <option
                                                                            @if (old('qualification_id', $data['qualification_id']) == $info->id) selected="selected" @endif
                                                                            value="{{ $info->id }}">
                                                                            {{ $info->name }} </option>
                                                                    @endforeach
                                                                @endif
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="graduation_estimate" id="graduation_estimate"
                                                                ...
                                                                <option @if (old('graduation_estimate', $data['graduation_estimate']) == 'Fair') selected @endif
                                                                    value="Fair">مقبول</option>
                                                                <option @if (old('graduation_estimate', $data['graduation_estimate']) == 'Good') selected @endif
                                                                    value="Good">جيد</option>
                                                                <option @if (old('graduation_estimate', $data['graduation_estimate']) == 'Very_Good') selected @endif
                                                                    value="Very_Good">جيد جدآ</option>
                                                                <option @if (old('graduation_estimate', $data['graduation_estimate']) == 'Excellent') selected @endif
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="brith_date" id="brith_date"
                                                                    ...
                                                                    value="{{ old('brith_date', $data['brith_date']) }}">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="national_id_place"
                                                                ...
                                                                value="{{ old('national_id_place', $data['national_id_place']) }}">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="end_national_id"
                                                                    ...
                                                                    class="form-control flatpickr bg-transparent"
                                                                    value="{{ old('end_national_id', $data['end_national_id']) }}">
                                                                <div class="input-group-append">
                                                                    <button type="button" class="wd-80 btn btn-dark"
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="social_status" id="social_status"
                                                                ...
                                                                <option @if (old('social_status', $data['social_status']) == 'Married') selected @endif
                                                                    value="Married">متزوج</option>
                                                                <option @if (old('social_status', $data['social_status']) == 'Single') selected @endif
                                                                    value="Single">أعزب</option>
                                                                <option @if (old('social_status', $data['social_status']) == 'Widowed') selected @endif
                                                                    value="Widowed">أرمل</option>
                                                                <option @if (old('social_status', $data['social_status']) == 'Divorced') selected @endif
                                                            ...
                                                            <select name="blood_types_id" id="blood_types_id"
                                                                ...
                                                                @if (@isset($other['blood_types']) && !@empty($other['blood_types']))
                                                                    @foreach ($other['blood_types'] as $info)
                                                                        <option
                                                                            @if (old('blood_types_id', $data['blood_types_id']) == $info->id) selected="selected" @endif
                                                                            value="{{ $info->id }}">
                                                                            {{ $info->name }} </option>
                                                                    @endforeach
                                                                @endif
                                                            ...
                                                            <select name="nationality_id" id="nationality_id"
                                                                ...
                                                                @if (@isset($other['nationalities']) && !@empty($other['nationalities']))
                                                                    @foreach ($other['nationalities'] as $info)
                                                                        <option
                                                                            @if (old('nationality_id', $data['nationality_id']) == $info->id) selected="selected" @endif
                                                                            value="{{ $info->id }}">
                                                                            {{ $info->name }} </option>
                                                                    @endforeach
                                                                @endif
                                                            ...
                                                            <select name="language_id" id="language_id"
                                                                ...
                                                                @if (@isset($other['languages']) && !@empty($other['languages']))
                                                                    @foreach ($other['languages'] as $info)
                                                                        <option
                                                                            @if (old('language_id', $data['language_id']) == $info->id) selected="selected" @endif
                                                                            value="{{ $info->id }}">
                                                                            {{ $info->name }} </option>
                                                                    @endforeach
                                                                @endif
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="religion" id="religion" class="form-control">
                                                                ...
                                                                <option @if (old('religion', $data['religion']) == 'Muslim') selected @endif
                                                                    value="Muslim">مسلم</option>
                                                                <option @if (old('religion', $data['religion']) == 'Christian') selected @endif
                                                                ...
                                                                @if (isset($other['governorates']) && !empty($other['governorates']))
                                                                    @foreach ($other['governorates'] as $info)
                                                                        <option value="{{ $info->id }}"
                                                                            {{ old('governorate_id', $data['governorate_id']) == $info->id ? 'selected' : '' }}>
                                                                            {{ $info->name }}
                                                                        </option>
                                                                    @endforeach
                                                                @endif
                                                            ...
                                                            <select name="city_id" id="city_id"
                                                                ...
                                                                @if (isset($other['cities']) && !empty($other['cities']))
                                                                    @foreach ($other['cities'] as $info)
                                                                        <option value="{{ $info->id }}"
                                                                            {{ old('city_id', $data['city_id']) == $info->id ? 'selected' : '' }}>
                                                                            {{ $info->name }}
                                                                        </option>
                                                                    @endforeach
                                                                @endif
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="staies_address"
                                                                ...
                                                                value="{{ old('staies_address', $data['staies_address']) }}">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="work_telephone"
                                                                ...
                                                                value="{{ old('work_telephone', $data['work_telephone']) }}">
                                                    ...
                                                    <div class="col-md-4 mb-3" id="military_hideandshow">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="military" id="military" class="form-control">
                                                                <option value="" selected>-- أختر الحالة --</option>
                                                                <option @if (old('military', $data['military']) == 'Exemption') selected @endif
                                                                ...
                                                                <option @if (old('military', $data['military']) == 'Complete') selected @endif
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="military_date_from"
                                                                    ...
                                                                    class="form-control flatpickr bg-transparent"
                                                                    value="{{ old('military_date_from', $data['military_date_from']) }}">
                                                                <div class="input-group-append">
                                                                    <button type="button" class="wd-80 btn btn-dark"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="military_date_to"
                                                                    ...
                                                                    class="form-control flatpickr bg-transparent"
                                                                    value="{{ old('military_date_to', $data['military_date_to']) }}">
                                                                <div class="input-group-append">
                                                                    <button type="button" class="wd-80 btn btn-dark"
                                                    ...
                                                    <div class="col-md-4 mb-3 related_miltary_1"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="military_wepon"
                                                                ...
                                                                value="{{ old('military_wepon', $data['military_wepon']) }}">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="military_exemption_date"
                                                                    ...
                                                                    placeholder="يوم / شهر / سنه"
                                                                    class="form-control flatpickr bg-transparent"
                                                                    value="{{ old('military_exemption_date', $data['military_exemption_date']) }}">
                                                                <div class="input-group-append">
                                                                    <button type="button" class="wd-80 btn btn-dark"
                                                    ...
                                                    <div class="col-md-4 mb-3" id="driving_license_hideandshow">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="driving_license" id="driving_license"
                                                                ...
                                                                <option @if (old('driving_license', $data['driving_license']) == 'Yes') selected @endif
                                                                    value="Yes">نعم</option>
                                                                <option @if (old('driving_license', $data['driving_license']) == 'No') selected @endif
                                                                    value="No">لا</option>
                                                            </select>
                                                    ...
                                                    <div class="col-md-4 mb-3 related_does_has_Driving_License"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="driving_license_type" id="driving_license_type"
                                                                ...
                                                                <option @if (old('driving_license_type', $data['driving_license_type']) == 'Special') selected @endif
                                                                    value="Special">رخصة خاصة</option>
                                                                <option @if (old('driving_license_type', $data['driving_license_type']) == 'First') selected @endif
                                                                    value="First">رخصة درجه أولى</option>
                                                                <option @if (old('driving_license_type', $data['driving_license_type']) == 'Second') selected @endif
                                                                    value="Second">رخصة درجه ثانية</option>
                                                                <option @if (old('driving_license_type', $data['driving_license_type']) == 'Third') selected @endif
                                                                    value="Third">رخصة درجه ثالثه</option>
                                                                <option @if (old('driving_license_type', $data['driving_license_type']) == 'Fourth') selected @endif
                                                                    value="Fourth">رخصة درجه رابعه</option>
                                                                <option @if (old('driving_license_type', $data['driving_license_type']) == 'Pro') selected @endif
                                                                    value="Pro">رخصة مهنية</option>
                                                                <option @if (old('driving_license_type', $data['driving_license_type']) == 'Motorcycle') selected @endif
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="has_relatives" id="has_relatives"
                                                                class="form-control">
                                                                <option value=""> -- اختر الحالة --</option>
                                                                <option @if (old('has_relatives', $data['has_relatives']) == 'Yes') selected @endif
                                                                    value="Yes">نعم</option>
                                                                <option @if (old('has_relatives', $data['has_relatives']) == 'No') selected @endif
                                                                    value="No">لا</option>
                                                            </select>
                                                            @error('has_relatives')
                                                                <span class="text-danger">{{ $message }}</span>
                                                    ...
                                                    <div class="col-md-8 Related_Relatives_detailsDiv mb-3"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text" name="relatives_details" id="relatives_details" class="form-control">{{ old('relatives_details', $data['relatives_details']) }}</textarea>
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="disabilities" id="disabilities"
                                                                class="form-control">
                                                                <option value=""> -- اختر الحالة --</option>
                                                                <option @if (old('disabilities', $data['disabilities']) == 'Yes') selected @endif
                                                                    value="Yes">نعم</option>
                                                                <option @if (old('disabilities', $data['disabilities']) == 'No') selected @endif
                                                                    value="No">لا</option>
                                                            </select>
                                                            @error('disabilities')
                                                                <span class="text-danger">{{ $message }}</span>
                                                    ...
                                                    <div class="col-md-8 mb-3 Related_is_Disabilities_processesDiv"
                                                        id="disabilities_type_hideandshow">
                                                        <div class="form-group">
                                                            <label> تفاصيل الاعاقة / عمليات سابقة</label>
                                                            <textarea type="text" name="disabilities_type" id="disabilities_type" class="form-control">{{ old('disabilities_type', $data['disabilities_type']) }} </textarea>
                                            ...
                                            <div class="tab-pane" id="tab5">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group" id="employee_hiring_date_input">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="work_start_date"
                                                                    ...
                                                                    class="form-control flatpickr bg-transparent"
                                                                    value="{{ old('work_start_date', $data['work_start_date']) }}">
                                                                <div class="input-group-append">
                                                                    <button type="button" class="wd-80 btn btn-dark"
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="functional_status" id="functional_status"
                                                                class="form-control">
                                                                <option value=""> -- اختر الحالة --</option>
                                                                <option @if (old('functional_status', $data['functional_status']) == 'Employee') selected @endif
                                                                    value="Employee">موظف</option>
                                                                <option @if (old('functional_status', $data['functional_status']) == 'Unemployed') selected @endif
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            <label> الدرجه الوظيفية</label> <span
                                                                class="tx-danger">*</span>
                                                            <select name="job_grade_id" id="job_grade_id"
                                                                ...
                                                                @if (@isset($other['job_grades']) && !@empty($other['job_grades']))
                                                                    @foreach ($other['job_grades'] as $info)
                                                                        <option
                                                                            @if (old('job_grade_id', $data['job_grade_id']) == $info->id) selected="selected" @endif
                                                                            value="{{ $info->id }}">
                                                                            {{ $info->name }}
                                                                            ({{ $info->min_salary * 1 }} -
                                                                            {{ $info->max_salary * 1 }})
                                                            ...
                                                            <div id="job_grade_id-error"
                                                                class="text-danger error-message d-none">
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <select name="department_id" id="department_id"
                                                                ...
                                                                @if (@isset($other['departements']) && !@empty($other['departements']))
                                                                    @foreach ($other['departements'] as $info)
                                                                        <option
                                                                            @if (old('department_id', $data['department_id']) == $info->id) selected="selected" @endif
                                                                            value="{{ $info->id }}">
                                                                            {{ $info->name }} </option>
                                                                    @endforeach
                                                                @endif
                                                            ...
                                                            <select name="job_categories_id" id="job_categories_id"
                                                                ...
                                                                @if (@isset($other['jobs']) && !@empty($other['jobs']))
                                                                    @foreach ($other['jobs'] as $info)
                                                                        <option
                                                                            @if (old('job_categories_id', $data['job_categories_id']) == $info->id) selected="selected" @endif
                                                                            value="{{ $info->id }}">
                                                                            {{ $info->name }} </option>
                                                                    @endforeach
                                                                @endif
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="has_attendance" id="has_attendance"
                                                                class="form-control">
                                                                <option value=""> -- اختر الحالة --</option>
                                                                <option @if (old('has_attendance', $data['has_attendance']) == 'Yes') selected @endif
                                                                    value="Yes">نعم</option>
                                                                <option @if (old('has_attendance', $data['has_attendance']) == 'No') selected @endif
                                                                    value="No">لا</option>
                                                            </select>
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="has_fixed_shift" id="has_fixed_shift"
                                                                class="form-control">
                                                                <option value=""> -- اختر الحالة --</option>
                                                                <option @if (old('has_fixed_shift', $data['has_fixed_shift']) == 'Yes') selected @endif
                                                                    value="Yes">نعم</option>
                                                                <option @if (old('has_fixed_shift', $data['has_fixed_shift']) == 'No') selected @endif
                                                                    value="No">لا</option>
                                                            ...
                                                            <select name="shift_types_id" id="shift_types_id"
                                                                ...
                                                                @if (@isset($other['shifts_types']) && !@empty($other['shifts_types']))
                                                                    @foreach ($other['shifts_types'] as $info)
                                                                        <option
                                                                            @if (old('shift_types_id', $data['shift_types_id']) == $info->id) selected="selected" @endif
                                                                            value="{{ $info->id }}">
                                                    ...
                                                    <div class="form-group mb-3 col-4" id="employee_add_service_input">
                                                        ...
                                                        <input type="text" name="add_service"
                                                            ...
                                                            value="{{ old('add_service', $data['add_service']) }}">
                                                        @error('add_service')
                                                    ...
                                                    <div class="form-group mb-3 col-4" id="employee_years_service_input">
                                                        ...
                                                        <input type="text" name="years_service" readonly
                                                            ...
                                                            value="{{ old('years_service', $data['years_service']) }}"
                                                            readonly>
                                                        @error('years_service')
                                                            <div class="alert alert-danger mb-0 mt-1" role="alert">
                                                                <span class="alert-inner--icon"><i
                                                    ...
                                                    <div class="form-group mb-3 col-4"
                                                        ...
                                                        <input type="text" name="num_vacation_days"
                                                            ...
                                                            value="{{ old('num_vacation_days', $data['num_vacation_days']) }}"
                                                            readonly>
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            <label> راتب الموظف اليومى</label>
                                                            <input name="day_price" id="day_price"
                                                                oninput="this.value=this.value.replace(/[^0-9]/g,'');"
                                                                class="form-control"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="motivation_type" id="motivation_type"
                                                                class="form-control">
                                                                <option value=""> -- اختر الحالة --</option>
                                                                <option @if (old('motivation_type', $data['motivation_type']) == 'Fixed') selected @endif
                                                                    value="Fixed">ثابت</option>
                                                                <option @if (old('motivation_type', $data['motivation_type']) == 'Changeable') selected @endif
                                                                    value="Changeable">متغير</option>
                                                                <option @if (old('motivation_type', $data['motivation_type']) == 'None') selected @endif
                                                    ...
                                                    <div class="col-md-4 mb-3" id="MotivationDIV_hideandshow">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="motivation" id="motivation"
                                                                oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                                                                class="form-control"
                                                                value="{{ old('motivation', $data['motivation']) }}">
                                                            @error('motivation')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="social_insurance" id="social_insurance"
                                                                class="form-control">
                                                                <option value=""> -- اختر الحالة --</option>
                                                                <option @if (old('social_insurance', $data['social_insurance']) == 'Yes') selected @endif
                                                                    value="Yes">نعم</option>
                                                                <option @if (old('social_insurance', $data['social_insurance']) == 'No') selected @endif
                                                                    value="No">لا</option>
                                                            </select>
                                                    ...
                                                    <div class="col-md-4 mb-3"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="social_insurance_number"
                                                                ...
                                                                value="{{ old('social_insurance_number', $data['social_insurance_number']) }}">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="medical_insurance" id="medical_insurance"
                                                                class="form-control">
                                                                <option value=""> -- اختر الحالة --</option>
                                                                <option @if (old('medical_insurance', $data['medical_insurance']) == 'Yes') selected @endif
                                                                    value="Yes">نعم</option>
                                                                <option @if (old('medical_insurance', $data['medical_insurance']) == 'No') selected @endif
                                                                    value="No">لا</option>
                                                            </select>
                                                    ...
                                                    <div class="col-md-4 mb-3 relatedismedicalinsurance"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="medical_insurance_cut_monthely"
                                                                ...
                                                                oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                                                                class="form-control"
                                                                value="{{ old('medical_insurance_cut_monthely', $data['medical_insurance_cut_monthely']) }}">
                                                    ...
                                                    <div class="col-md-4 mb-3 relatedismedicalinsurance"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="medical_insurance_number"
                                                                ...
                                                                oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                                                                value="{{ old('medical_insurance_number', $data['medical_insurance_number']) }}">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="Type_salary_receipt" id="Type_salary_receipt"
                                                                class="form-control">
                                                                <option value=""> -- اختر الحالة --</option>
                                                                <option @if (old('Type_salary_receipt', $data['Type_salary_receipt']) == 'Cach') selected @endif
                                                                    value="Cach">كاش</option>
                                                                <option @if (old('Type_salary_receipt', $data['Type_salary_receipt']) == 'Visa') selected @endif
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="active_vacation" id="active_vacation"
                                                                class="form-control">
                                                                <option value=""> -- اختر الحالة --</option>
                                                                <option @if (old('active_vacation', $data['active_vacation']) == 'Yes') selected @endif
                                                                    value="Yes">نعم</option>
                                                                <option @if (old('active_vacation', $data['active_vacation']) == 'No') selected @endif
                                                                    value="No">لا</option>
                                                            </select>
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="fixed_allowances" id="fixed_allowances"
                                                                class="form-control">
                                                                <option value=""> -- اختر الحالة --</option>
                                                                <option @if (old('fixed_allowances', $data['fixed_allowances']) == '1') selected @endif
                                                                    value="1">نعم</option>
                                                                <option @if (old('fixed_allowances', $data['fixed_allowances']) == '0') selected @endif
                                                                    value="0">لا</option>
                                                            </select>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="name_sponsor" id="name_sponsor"
                                                                class="form-control"
                                                                value="{{ old('name_sponsor', $data['name_sponsor']) }}">
                                                            @error('name_sponsor')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="pasport_identity"
                                                                ...
                                                                oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                                                                value="{{ old('pasport_identity', $data['pasport_identity']) }}">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="pasport_from_place"
                                                                ...
                                                                value="{{ old('pasport_from_place', $data['pasport_from_place']) }}">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="pasport_exp_date"
                                                                    ...
                                                                    class="form-control flatpickr bg-transparent"
                                                                    value="{{ old('pasport_exp_date', $data['pasport_exp_date']) }}">
                                                                <div class="input-group-append">
                                                                    <button type="button" class="wd-80 btn btn-dark"
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <input type="file" name="photo" id="photo"
                                                            value="{{ old('photo', $data['photo']) }}" class="dropify"
                                                            data-height="500" />
                                                        @if ($data['image'])
                                    ...
                                    <div class="row col-6 mx-auto">
                                        <div class="col-md-6 mx-auto mt-3 mb-3">
                                            <div class="form-group">
                                                <button class="btn ripple btn-primary btn-block" type="submit">تعديل
                                                    البيانات</button>
                                            </div>
                                        </div>
                                    </div>
