            ...
            <div class="panel panel-primary tabs-style-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select wire.model="qualification_id" id="qualification_id"
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select wire.model="graduation_estimate" id="graduation_estimate"
                                            class="form-control">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select wire.model="blood_types_id" id="blood_types_id"
                                            class="form-control select2 ">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select wire.model="language_id" id="language_id"
                                            class="form-control select2 ">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group" id="governorates_Div">
                                        ...
                                        <select wire.model="governorate_id" id="governorate_id"
                                            class="form-control select2">
                                ...
                                <div class="col-md-4 mb-3 related_miltary_1" id="military_date_from_hideandshow">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" wire.model="military_date_from"
                                ...
                                <div class="col-md-4 mb-3" id="driving_license_hideandshow">
                                    <div class="form-group">
                                        ...
                                        <select wire.model="driving_license" id="driving_license"
                                            class="form-control">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select wire.model="functional_status" id="functional_status"
                                            class="form-control">
                                            <option value=""> -- اختر الحالة --</option>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select wire.model="job_grade_id" id="job_grade_id"
                                            class="form-control select2 ">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select wire.model="has_fixed_shift" id="has_fixed_shift"
                                            class="form-control">
                                            <option value=""> -- اختر الحالة --</option>
                                            <option value="Yes">نعم</option>
                                            <option value="No">لا</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select wire.model="motivation_type" id="motivation_type"
                                            class="form-control">
                                            <option value=""> -- اختر الحالة --</option>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select wire.model="social_insurance" id="social_insurance"
                                            class="form-control">
                                            <option value=""> -- اختر الحالة --</option>
                                            <option value="Yes">نعم</option>
                                            <option value="No">لا</option>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select wire.model="medical_insurance" id="medical_insurance"
                                            class="form-control">
                                            <option value=""> -- اختر الحالة --</option>
                                            <option value="Yes">نعم</option>
                                            <option value="No">لا</option>
                                ...
                                <div class="col-md-4 mb-3 relatedismedicalinsurance"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" wire.model="medical_insurance_number"
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select wire.model="Type_salary_receipt" id="Type_salary_receipt"
                                            class="form-control">
                                            <option value=""> -- اختر الحالة --</option>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select wire.model="active_vacation" id="active_vacation"
                                            class="form-control">
                                            <option value=""> -- اختر الحالة --</option>
                                            <option value="Yes">نعم</option>
                                            <option value="No">لا</option>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" wire.model="urgent_person_details"
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select wire.model="fixed_allowances" id="fixed_allowances"
                                            class="form-control">
                                            <option value=""> -- اختر الحالة --</option>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" wire.model="name_sponsor" id="name_sponsor"
                                            class="form-control">
                                        @error('name_sponsor')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                ...
                <div class="row col-6 mx-auto">
                    <div class="col-md-6 mx-auto mt-3 mb-3">
                        <div class="form-group">
                            <button
                                class="btn btn-md btn-primary  d-grid d-flex align-items-center justify-content-center"
                                type="submit">
                                <div wire:loading.remove>
                                    <span>تأكيد البيانات</span>
                                </div>
                                <div class="spinner-border text-white" wire:loading wire:target="submit"
                                    role="status">
