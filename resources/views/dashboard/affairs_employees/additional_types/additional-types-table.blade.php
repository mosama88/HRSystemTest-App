    ...
    <div class="row row-sm">
        <div class="col-lg-6">
            <div class="input-group mb-3">
                ...
                <input aria-describedby="basic-addon1" wire:model.live="name_search" aria-label="أبحث بأسم الأضافى"
                    class="form-control" placeholder="أبحث بأسم الأضافى" type="text">
            </div><!-- input-group -->
        </div>
    </div>
                                    ...
                                    <div class="dropdown-menu tx-13">
                                        <h6 class="dropdown-header tx-uppercase tx-11 tx-bold tx-inverse tx-spacing-1">
                                            ...
                                            <a class="dropdown-item modal-effect btn btn-outline-info btn-sm"
                                                ...
                                                wire:click.prevent="$dispatch('editAdditionalTypes',{id:{{ $info->id }}})"><i
                                            ...
                                            @if ($info->counterUsed == 0)
                                                ...
                                                <a class="dropdown-item modal-effect btn btn-outline-danger btn-sm"
                                                    ...
                                                    wire:click.prevent="$dispatch('deleteAdditionalTypes',{id:{{ $info->id }}})"
