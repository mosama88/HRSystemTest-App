    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                inputmode="numeric" pattern="\d*" class="form-control"
                value="{{ intval($sanctions['value']) }}">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input autofocus type="text" oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                  readonly  name="total_edit" id="total_edit" class="form-control" value="{{ $sanctions['total'] }}">
                @error('total')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
