                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        <div class="invoice-header">
                            <h1 class="invoice-title">أضافى الرواتب بالشهر المالى
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                <label class="tx-gray-600">تفاصيل الأضافى</label>
                                <p class="invoice-info-row"><span>اجمالى الأضافى بالجنية</span>
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 10%">عدد أيام الأضافى</th>
