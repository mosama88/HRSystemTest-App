...
@section('title', 'رواتب الموظفين المفصلة')
@section('css')
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">بيانات رواتب الموظفين المفصلة </h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    قائمة رواتب الموظفين المفصلة
                </span>
            </div>
        </div>
                                    ...
                                    <tbody>
                                        @foreach ($data as $info)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($info->is_open != 0)
                                                        <a href="{{ route('dashboard.mainSalaryEmployees.show', $info->id) }}"
                                                            class="btn-sm btn btn-info mr-2">
                                                            <i class="fas fa-eye ml-1"></i> عرض الرواتب</a>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
