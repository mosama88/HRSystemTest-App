...
@section('title', 'طباعة الخصومات الشهرية')
@section('css')
    <style>
        @media print {
            #print_Button {
                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        <div class="invoice-header">
                            <h1 class="invoice-title">خصومات الرواتب بالشهر المالى
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                <label class="tx-gray-600">تفاصيل الخصومات</label>
                                <p class="invoice-info-row"><span>اجمالى الخصومات بالجنية</span>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $info)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">{{ $info->DiscountType->name }}</td>
