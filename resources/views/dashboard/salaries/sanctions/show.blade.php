...
@section('title', 'عرض جزاءات الشهر المالى')
@section('css')
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h5 class="content-title mb-0 my-auto">بيانات الجزاءات الرواتب للشهر
                    المالى {{ $finance_cln_periods_data->month->name }}</h5><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    <a style="font-weight:bold;color:#117ea1;" href="{{ route('dashboard.sanctions.index') }}">
                        <i class="fas fa-arrow-circle-left fa-lg ml-1"></i> سجلات جزاءات الموظفين
                    </a>
                </span>
            </div>
        </div>
                ...
                <div class="mb-3 mb-xl-0">
                    <div class="btn-group dropdown">
                        <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-super-scaled"
                            data-toggle="modal" href="#modaldemo8"> <i class="fas fa-plus-circle"></i> أضافة جزاء جديد</a>
                    </div>
                </div>
            </div>
        @endif
    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">
                            بيانات جزاءات الرواتب للشهر المالى (<span
                ...
                <form method="POST" action="{{ route('dashboard.sanctions.print_search') }}" target="_blank">
                    @csrf
                    ...
                    <div class="col-10 mx-auto mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class=" col-3">
                                <div class="form-group">
                                    <label> بحث بنوع الجزاءات </label>
                                    <select name="sanctions_type_search" id="sanctions_type_search" class="form-control">
                                        <option value="all">بحث بالكل</option>
                                            ...
                                            <tr>
                                                ...
                                                @if ($finance_cln_periods_data['is_open'] == 1)
                                                    <td>
                                                        ...
                                                        @include('dashboard.salaries.sanctions.delete')
                                                    </td>
                                                @endif
                                            </tr>
                                        @endforeach
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">أضافة جزاءات للموظفين للشهر المالى</h6>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input autofocus type="text" name="value_add" id="value_add"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input autofocus type="text" name="total_add" id="total_add" class="form-control"
                                    value="0" readonly>
                                @error('total')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#do_add_now', function(e) {
                ...
                if (value_add === "") {
                    ...
                    Swal.fire({
                        icon: 'warning',
                        title: 'تحذير',
                        text: 'من فضلك ادخل عدد ايام الجزاء',
                        customClass: {
                            container: 'swal2-override'
                        }
                    }).then((result) => {
                ...
                if (total_add === "") {
                    ...
                    Swal.fire({
                        icon: 'warning',
                        title: 'تحذير',
                        text: 'من فضلك ادخل اجمالي الجزاء',
                        customClass: {
                            container: 'swal2-override'
                        }
                    }).then((result) => {
                ...
                // عمل فحص قبل التخزين
                $.ajax({
                    url: '{{ route('dashboard.sanctions.checkExsistsBefor') }}',
                    type: 'post',
                    dataType: 'json',
                    cache: false,
                    data: {
                    ...
                    success: function(data) {
                        if (data == 'exsists_befor') {
                            ...
                            Swal.fire({
                                title: 'تحذير',
                                text: 'يوجد سجل جزاءات سابق مسجل للموظف هل تريد الاستمرار؟',
                                icon: 'warning',
                    ...
                    error: function(xhr, status, error) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'خطأ',
                            text: 'عفوا لقد حدث خطأ في التحقق من الجزاءات السابقة',
                            customClass: {
                                container: 'swal2-override'
                            }
                        }).then(() => {
            ...
            function submitSanction() {
                ...
                $.ajax({
                    url: '{{ route('dashboard.sanctions.store') }}',
                    type: 'post',
                    dataType: 'html',
                    cache: false,
                    data: {
                        ...
                        sanctions_type: sanctions_type_add,
                        value: value_add,
                        total: total_add,
                        notes: notes_add,
                        day_price: day_price,
    ...
    <script>
        ...
        function ajax_search() {
            ...
            jQuery.ajax({
                url: '{{ route('dashboard.sanctions.ajax-search') }}',
                type: 'post',
                dataType: 'html',
                cache: false,
                data: {
        ...
        $('#employee_code_search, #sanctions_type_search, #is_archived_search').change(function() {
            ajax_search();
        });
    </script>
    ...
    <script>
        ...
        $(document).on('click', '.load_edit_this_row', function(e) {
            ...
            jQuery.ajax({
                url: '{{ route('dashboard.sanctions.load_edit_row') }}',
                type: 'post',
                dataType: 'html',
                cache: false,
                data: {
        ...
        $(document).on('click', '#do_edit_now', function(e) {
            ...
            if (sanctions_type_edit === "") {
                return showWarning('من فضلك اختر نوع الجزاء', '#sanctions_type_edit');
            }
            ...
            if (value_edit === "") {
                return showWarning('من فضلك ادخل عدد ايام الجزاء', '#value_edit');
            }
            $('#EditModal').modal('show'); // إظهار الـ modal مرة أخرى
            ...
            if (total_edit === "") {
                return showWarning('من فضلك ادخل اجمالي الجزاء', '#total_edit');
            }
            $('#EditModal').modal('show'); // إظهار الـ modal مرة أخرى
            ...
            jQuery.ajax({
                url: '{{ route('dashboard.sanctions.do_edit_row') }}',
                type: 'post',
                dataType: 'html',
                cache: false,
                data: {
                    ...
                    main_salary_employees_id: main_salary_employees_id,
                    id: id,
                    sanctions_type: sanctions_type_edit,
                    value: value_edit,
                    total: total_edit,
                    notes: notes_edit,
                    day_price: day_price
