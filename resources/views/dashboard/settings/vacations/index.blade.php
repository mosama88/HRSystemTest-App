                ...
                <div class="mb-3 mb-xl-0">
                    <div class="btn-group dropdown">
                        <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-super-scaled"
                            data-toggle="modal" href="#modaldemo8"> <i class="fas fa-plus-circle"></i> أضافة نوع أجازه
                            جديدة</a>

                        @include('dashboard.settings.vacations.create')
                    </div>
                </div>
            </div>
        @endcan
                        ...
                        @if (@isset($data) && !@empty($data))
                            <table class="table text-md-nowrap" id="example2">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th class="wd-15p border-bottom-0"> اسم الأجازه</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $info)
                                        ...
                                        <tr>
                                            ...
                                            @include('dashboard.settings.vacations.edit')
                                        </tr>
                                        @include('dashboard.settings.vacations.delete')
                                    @endforeach
                                </tbody>
                            </table>
                        @else
