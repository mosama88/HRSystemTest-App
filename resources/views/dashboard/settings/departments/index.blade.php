                ...
                <div class="mb-3 mb-xl-0">
                    <div class="btn-group dropdown">
                        <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-super-scaled"
                            data-toggle="modal" href="#modaldemo8"> <i class="fas fa-plus-circle"></i> أضافة إدارة جديده</a>

                        @include('dashboard.settings.departments.create')
                    </div>
                </div>
            </div>
        @endcan
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $info)
                                        ...
                                        <tr>
                                            ...
                                            @include('dashboard.settings.departments.delete')
                                        </tr>
                                        @include('dashboard.settings.departments.edit')
                                    @endforeach
                                </tbody>
                            </table>
                        @else
