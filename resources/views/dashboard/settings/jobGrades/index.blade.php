                ...
                <div class="mb-3 mb-xl-0">
                    <div class="btn-group dropdown">
                        <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-super-scaled"
                            data-toggle="modal" href="#createModal"> <i class="fas fa-plus-circle"></i> أضافة درجة وظيفية
                            جديده</a>

                        @livewire('dashboard.settings.jobGrades.job-grades-create')
        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @livewire('dashboard.settings.jobGrades.job-grades-table')
                    @livewire('dashboard.settings.jobGrades.job-grades-update')


                </div><!-- bd -->
                @livewire('dashboard.settings.jobGrades.job-grades-delete')
            </div><!-- bd -->
        </div>
        <!--/div-->
    </div>
