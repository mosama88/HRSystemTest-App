            ...
            <div class="mb-3 mb-xl-0">
                <div class="btn-group dropdown">
                    <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-super-scaled"
                        data-toggle="modal" href="#modaldemo8"> <i class="fas fa-plus-circle"></i> أضافة وظيفة جديده</a>

                    @include('dashboard.settings.jobsCategories.create')
                </div>
            </div>
        </div>
        @endcan
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $info)
                                        ...
                                        <tr>
                                            ...
                                            @include('dashboard.settings.jobsCategories.edit')
                                        </tr>
                                        @include('dashboard.settings.jobsCategories.delete')
                                    @endforeach
                                </tbody>
                            </table>
                        @else
