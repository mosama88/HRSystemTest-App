        ...
        <div class="col-lg-6">
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    ...
                    class="form-control" placeholder="أبحث بنوع الوظيفة" type="text">
            </div><!-- input-group -->
        </div>
                                    ...
                                    <div class="dropdown-menu tx-13">
                                        ...
                                        @can('تعديل الوظائف')
                                            ...
                                            <a class="dropdown-item modal-effect btn btn-outline-info btn-sm"
                                                ...
                                                wire:click.prevent="$dispatch('editjobsCategories',{id:{{ $info->id }}})"><i
                                        ...
                                        @can('حذف الوظائف')
                                            @if ($info->counterUsed == 0)
                                                ...
                                                <a class="dropdown-item modal-effect btn btn-outline-danger btn-sm"
                                                    ...
                                                    wire:click.prevent="$dispatch('deletejobsCategories',{id:{{ $info->id }}})"
