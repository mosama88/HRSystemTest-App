    ...
    <div class="row row-sm">
        <div class="col-lg-6">
            <div class="input-group mb-3">
                ...
                <input aria-describedby="basic-addon1" wire:model.live="name_search" aria-label="أبحث بأسم الفصيلة"
                    class="form-control" placeholder="أبحث بأسم الفصيلة" type="text">
            </div><!-- input-group -->
        </div>
    </div>
        ...
        @if (@isset($data) && !@empty($data))
            <table class="table table-striped mg-b-0 text-md-nowrap">
                <thead>
                    <tr>
                        <th>#</th>
                        <th class="wd-15p border-bottom-0"> اسم الفصيلة</th>
                                    ...
                                    <div class="dropdown-menu tx-13">
                                        ...
                                        @if ($info->counterUsed == 0)
                                                ...
                                                <a class="dropdown-item modal-effect btn btn-outline-danger btn-sm"
                                                    ...
                                                    wire:click.prevent="$dispatch('deleteBloodTypes',{id:{{ $info->id }}})"
