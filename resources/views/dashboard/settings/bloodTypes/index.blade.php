                ...
                <div class="mb-3 mb-xl-0">
                    <div class="btn-group dropdown">
                        <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-super-scaled"
                            data-toggle="modal" href="#modaldemo8"> <i class="fas fa-plus-circle"></i> أضافة فصيلة دم جديدة</a>
                            ...
                            <table class="table text-md-nowrap" id="example2">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="wd-15p border-bottom-0"> فصيلة الدم</th>
                                                ...
                                                @can('حذف فصيلة الدم')
                                                    @if ($info->counterUsed == 0)
                                                        ...
                                                        <a class="modal-effect btn btn-outline-danger btn-sm"
                                                            data-effect="effect-scale" data-toggle="modal"
                                                            href="#delete{{ $info->id }}" data-id="{{ $info->id }}">
