    ...
    <div class="row row-sm">
        <div class="col-lg-6">
            <div class="input-group mb-3">
                ...
                <input aria-describedby="basic-addon1" wire:model.live="name_search" aria-label="أبحث بأسم الأستقالة"
                    class="form-control" placeholder="أبحث بأسم الأستقالة" type="text">
            </div><!-- input-group -->
        </div>
    </div>
                                    ...
                                    <div class="dropdown-menu tx-13">
                                        ...
                                        @can('تعديل الأستقالة')
                                            ...
                                            <a class="dropdown-item modal-effect btn btn-outline-info btn-sm"
                                                ...
                                                wire:click.prevent="$dispatch('editResignations',{id:{{ $info->id }}})"><i
                                        ...
                                        @can('حذف الأستقالة')
                                            @if ($info->counterUsed == 0)
                                                ...
                                                <a class="dropdown-item modal-effect btn btn-outline-danger btn-sm"
                                                    ...
                                                    wire:click.prevent="$dispatch('deleteResignations',{id:{{ $info->id }}})"
