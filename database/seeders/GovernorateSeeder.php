    ...
    public function run(): void
    {
        DB::table('governorates')->insert(
            [
                ...
                ['name' => 'الجيزه', 'country_id' => 1],
                ['name' => 'الاسكندرية', 'country_id' => 1],
                ...
                ['name' => 'بنها', 'country_id' => 1],
                ['name' => 'الفيوم', 'country_id' => 1],
                ['name' => 'بنى سويف', 'country_id' => 1],
                ['name' => 'الشرقيه', 'country_id' => 1],
            ]
        );
    }
}