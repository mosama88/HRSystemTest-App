...
return new class extends Migration
{
    ...
    {
        Schema::create('employee_salary_rewards', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('additional_types_id')->comment(' نوع إضافى المكافئة ')->references('id')->on('additional_types')->onUpdate('cascade');
            $table->decimal('total', 10, 2)->comment('أجمالى المكافئة');
    ...
    {
        Schema::dropIfExists('employee_salary_rewards');
    }
};
