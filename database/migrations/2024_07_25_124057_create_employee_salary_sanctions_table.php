...
return new class extends Migration
{
    ...
    {
        Schema::create('employee_salary_sanctions', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('value', 10, 2)->comment('كام يوم جزاء');
            $table->decimal('total', 10, 2)->comment('أجمالى الجزاءات');
    ...
    {
        Schema::dropIfExists('employee_salary_sanctions');
    }
};
